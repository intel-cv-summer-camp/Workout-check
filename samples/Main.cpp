...
const std::string caffeConfigFile = "./random_nnet/deploy.prototxt.txt";
const std::string caffeWeightFile = "./random_nnet/res10_300x300_ssd_iter_140000_fp16.caffemodel";
